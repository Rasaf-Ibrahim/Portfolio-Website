  ...
  <div class="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto  lg:my-0">
	...
	<div id="profile" class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-50 mx-6 lg:mx-0">
		...
		<div class="p-4 md:p-12 text-center lg:text-left">
			...
			<div class="block lg:hidden rounded-full shadow-xl mx-auto md:-mt-16 h-48 w-48 bg-cover bg-center" style="background-image: url('https://raw.githubusercontent.com/Rasaf-Ibrahim/--Portfolio-Website--/Aditto/assets/images/index.jpeg?token=AQUTL54JUWTD6BKM5FB3ANLBDD5L4')"></div>
			...
			<div class="mt-4 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center  space-x-8">
	...
	<div class="w-full lg:w-2/5">
		...
		<img src="https://raw.githubusercontent.com/Rasaf-Ibrahim/--Portfolio-Website--/Aditto/assets/images/index.jpeg?token=AQUTL54JUWTD6BKM5FB3ANLBDD5L4" class="rounded-none lg:rounded-lg shadow-2xl hidden lg:block">
